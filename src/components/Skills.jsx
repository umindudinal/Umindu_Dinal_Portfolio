   ...
   return (
      ...
      className='py-20 bg-dark-100'>
         ...
         <div className='container mx-auto px-6'>
            ...
            <p className='text-gray-400 text-center max-w-2xl mx-auto mb-16'>I have expertise in a wide range of technologies and tools, including React, Next.js, Node.js, and more.</p>
